...
3-	Secuencia: hace referencia al orden de ejecución de instrucciones, tal y como lo dice el nombre, de forma secuencial (una instrucción después de la otra). Como consecuencia el resultado de la instrucción anterior puede afectar la siguiente.
Selección: para que se ejecute la instrucción, se tiene que cumplir cierta condición o ciertas condiciones. Las condiciones devuelven un valor, verdadero o falso, dando así las pautas a seguir. Un ejemplo sin armar una estructura seria “si 10=10(condición) entonces imprimí “si” (declaración)”. Las tres estructuras principales de selección son IF, IF-ELSE y SWITCH.
Iteración: es una estructura de repetición que permite de forma eficiente crear un bucle que se ejecute un numero especifico de veces, o indefinidamente mientras se cumpla una condición. Las dos estructuras principales son FOR Y WHILE.
